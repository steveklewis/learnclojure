(ns beaches.handler
  (:require [compojure.core :refer [defroutes routes wrap-routes]]
            [beaches.routes.home :refer [home-routes]]
            [beaches.routes.services :refer [service-routes]]
            [beaches.middleware :as middleware]
            [beaches.session :as session]
...
(defn destroy
  ...
  []
  (timbre/info "beaches is shutting down...")
  (stop-nrepl)
